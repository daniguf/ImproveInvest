  ...
  return (
    <section ref={containerRef} className="relative w-full h-full">
      <svg
        ...
        id="svg"
        className="absolute -z-50 top-1/3 right-1/4 2xl:block hidden"
        fill="#131c2e"
      >
      ...
      <MaxWidthWrapper>
        ...
        <div className="flex justify-center items-center w-full text-white text-sm py-16">
          <div className="flex flex-col xl:w-1/3 gap-4">
            <p>{bodyContentParagraphs.p1}</p>
            <p className="bg-secondary xl:p-2">{bodyContentParagraphs.p2}</p>
          </div>
        </div>
        <div className="flex xl:justify-end items-center w-full text-white text-sm">
          <Link href={"/mira"}>
