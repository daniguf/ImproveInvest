  ...
  return (
    <>
      <section ref={containerRef} className="relative w-full">
        <div className="relative value-panel h-screen lg:flex items-center justify-center  bg-variant">
          <MaxWidthWrapper>
            <div className="relative h-5/6 text-white flex flex-col">
              <span className="hidden lg:block absolute -left-10 h-full bg-blue-600 w-1"></span>
              <span className="hidden xl:block absolute -bottom-10 w-1/3 bg-blue-800 h-1"></span>
              ...
              <div className="lg:flex h-full">
                <div className="flex-1 lg:grid grid-cols-4 grid-rows-3 p-4 max-lg:py-8">
        ...
        <div className="relative value-panel h-screen lg:flex items-center justify-center">
          <MaxWidthWrapper>
            <div className="relative h-5/6 text-white flex flex-col">
              <span className="hidden lg:block absolute -left-10 h-full bg-blue-700 w-1"></span>
              <span className="hidden xl:block absolute -bottom-10 w-2/3 bg-blue-800 h-1"></span>
              ...
              <div className="lg:flex h-full">
                ...
                <div className="flex-1 lg:grid grid-cols-4 grid-rows-3 p-4">
        ...
        <div className="relative value-panel h-screen lg:flex items-center justify-center bg-variant">
          <MaxWidthWrapper>
            <div className="relative h-5/6 text-white flex flex-col">
              <span className="hidden lg:block absolute -left-10 h-full bg-blue-800 w-1"></span>
              <span className="hidden xl:block absolute -bottom-10 w-full bg-blue-800 h-1 animate-pulse"></span>
