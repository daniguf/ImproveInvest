...
const SecondSectionElement: React.FC<ISecondSectionElement> = ({
  ...
  return (
    <div className="relative flex flex-col gap-1 p-8 lg:p-12 rounded-lg text-md bg-[#eeeff0]">
...
const LandingPageContentSection: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="relative min-h-[70dvh] max-w-[1128px] mx-auto flex flex-col gap-x-8 lg:flex-row items-center justify-center py-14 px-8 ">
        <div className="h-full w-full flex flex-col items-center justify-center">
          <div className="flex flex-col justify-center">
            <h2 className="text-primary font-bold text-3xl">{t("29c1007")}</h2>
        ...
        <div className="py-8 lg:py-0 content-center">
          <Image
            ...
            height={400}
            width={266}
            className="h-auto w-[350px] sm:w-[550px] lg:w-[1100px] rounded-xl"
          />
        </div>
      </section>
      {/* Med Improve Invest A/S får du: */}
      <section className="bg-[#f6f7f8] w-full flex flex-col py-8 px-8 sm:px-14 gap-8 justify-center items-center text-tertiary">
        <div className="max-w-[1128px]">
          <h2 className="w-full text-center text-primary font-bold text-4xl py-16">
            {t("6929745")}
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <p>{t("section_2.block_1.paragraph_1")}</p>
              <p>{t("section_2.block_1.paragraph_2")}</p>
              <p>{t("section_2.block_1.paragraph_3")}</p>
            </SecondSectionElement>
            <SecondSectionElement
            ...
            >
              <p>{t("section_2.block_2.paragraph_1")}</p>
              <p>{t("section_2.block_2.paragraph_2")}</p>
              <p>{t("section_2.block_2.paragraph_3")}</p>
              <p>{t("section_2.block_2.paragraph_4")}</p>
              <p>{t("section_2.block_2.paragraph_5")}</p>
              <p>{t("section_2.block_2.paragraph_6")}</p>
            </SecondSectionElement>
            <SecondSectionElement
            ...
            >
              <p>{t("section_2.block_3.paragraph_1")}</p>
              <p>{t("section_2.block_3.paragraph_2")}</p>
              <p>{t("section_2.block_3.paragraph_3")}</p>
              <p>{t("section_2.block_3.paragraph_4")}</p>
              <p>{t("section_2.block_3.paragraph_5")}</p>
            </SecondSectionElement>
            <SecondSectionElement
            ...
            >
              <p>{t("section_2.block_4.paragraph_1")}</p>
              <p>{t("section_2.block_4.paragraph_2")}</p>
              <p>{t("section_2.block_4.paragraph_3")}</p>
              <p>{t("section_2.block_4.paragraph_4")}</p>
            </SecondSectionElement>
          </div>
        </div>
      </section>
      {/* BEGRÆNSET RISIKO */}
      <section className="max-w-[1128px] flex flex-col mx-auto py-8 px-8 sm:px-14 gap-8 justify-center items-center text-tertiary">
        <h2 className="py-8 text-primary font-bold text-4xl">{t("52f4110")}</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-5 gap-x-4">
          <div className="flex flex-col gap-4 p-8 rounded-lg shadow-2xl shadow-gray-400">
            <p>{t("section_3.81aee53")}</p>
            <p>{t("section_3.fa44e87")}</p>
          </div>
          <div className="flex flex-col gap-4 p-8 rounded-lg shadow-2xl shadow-gray-400">
            <p>{t("section_3.25bab45")}</p>
            <p>{t("section_3.0aee6db")}</p>
            <p>{t("section_3.e2c2fb9")}</p>
          </div>
          <div className="flex flex-col gap-4 p-8 rounded-lg shadow-2xl shadow-gray-400">
            <p>{t("section_3.414f1ac")}</p>
            <p>{t("section_3.a7c8044")}</p>
            <p>{t("section_3.44a6fb4")}</p>
          </div>
        </div>
        <div>
          <p className="flex sm:flex-row flex-col gap-1 text-center">
            <span>{t("section_3.c58db7c")}</span>
            <Link href={"/priip-kid"} className="text-primary underline">
              {t("section_3.bx354d4")}
            </Link>
          </p>
        </div>
      ...
      <section className="max-w-[1128px] flex flex-col md:flex-row mx-auto py-8 px-8 sm:px-14 gap-y-8 justify-center items-center text-tertiary">
        ...
        <div className="flex-1">
          <h2 className="max-w-dvw text-primary font-bold text-3xl mb-4">
            {t("888c09c")}
          </h2>
